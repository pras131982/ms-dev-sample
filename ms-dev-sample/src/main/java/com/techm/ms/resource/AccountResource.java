...
public interface AccountResource {
	...
	public Response findAllAccounts();
	  ...
	  /**
     * Service definition which returns account by name
	...
	@ApiOperation(
			value = "Get Account By Name",
			notes = "Returns account by name",
			response = AccountResponse.class)
	@ApiResponses(
			value = {
					@ApiResponse(code = 200, message = "OK"),
	...
	public Response findAccountByName(@ApiParam(value = "name that need to be updated", required = true) @PathParam("username") String username);
